...
<html>
    ...
    <body class="nav-fixed">
                ...
                <main>
                    ...
                    <div class="container-xl px-4 mt-5">
						...
						<div class="card">
							...
							<div class="card-body">
                                <button id="export-buttons" class="btn btn-success">Export Excel</button>

                                <table id="data-table-export">
                                    <thead>
										<tr>
        ...
        <script>
            ...
            dataTable.buttons('.btn-excel').container().appendTo($('#export-buttons'));
        </script>
    </body>
</html>