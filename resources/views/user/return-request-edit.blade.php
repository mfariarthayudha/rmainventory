...
<head>
    ...
    <title>Edit Pengembalian | RMA Inventory</title>
                ...
                <div class="container-xl px-4 mt-5">
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="/return-requests/_edit" enctype="multipart/form-data">
                                @csrf

                                <input type="hidden" name="return_request_id" value="{{ $returnRequest->return_request_id }}">

                                <div class="row mb-3">
                                    <div class="col-12 col-lg-6">
                                        <div class="mb-3">
                                            <label for="identifier-input">No.IO/SP2K/SO/PO/ANDOP</label>
                                            <input class="form-control" id="identifier-input" type="text" value="{{ $returnRequest->identifier }}" placeholder="Masukkan No.IO/SP2K/SO/PO/ANDOP" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="password-confirmation-input" type="text" name="origin" value="{{ $returnRequest->origin }}" placeholder="Masukkan Lokasi Asal">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="customer-name-input" type="text" name="customer_name" value="{{ $returnRequest->customer_name }}" placeholder="Masukkan Customer Name">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="type-input" type="text" name="type" value="{{ $returnRequest->type }}" placeholder="Masukkan Type">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="brand-input" type="text" name="brand" value="{{ $returnRequest->brand }}" placeholder="Masukkan Merk">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="serial-number-input" type="text" name="serial_number" value="{{ $returnRequest->serial_number }}" placeholder="Masukkan Serial Number">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="col-12 mb-3">
                                            ...
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" id="continue" name="continue_checkbox" type="checkbox" value="{{ $returnRequest->continue_checkbox }}" @if ($returnRequest->continue_checkbox == 1) checked @endif>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="dead-on-arrival" name="dead_on_arrival_checkbox" type="checkbox" value="{{ $returnRequest->dead_on_arrival_checkbox }}" @if ($returnRequest->dead_on_arrival_checkbox == 1) checked @endif>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="dead-on-operational" name="dead_on_operational_checkbox" type="checkbox" value="{{ $returnRequest->dead_on_operational_checkbox }}" @if ($returnRequest->dead_on_operational_checkbox == 1) checked @endif>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="ber-indicator" name="ber_indicator_checkbox" type="checkbox" value="{{ $returnRequest->ber_indicator_checkbox }}" @if ($returnRequest->ber_indicator_checkbox == 1) checked @endif>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="software-error" name="software_error_checkbox" type="checkbox" value="{{ $returnRequest->software_error_checkbox }}" @if ($returnRequest->software_error_checkbox == 1) checked @endif>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="tributary-error" name="tributary_error_checkbox" type="checkbox" value="{{ $returnRequest->tributary_error_checkbox }}" @if ($returnRequest->tributary_error_checkbox == 1) checked @endif>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="channel-error" name="channel_error_checkbox" type="checkbox" value="{{ $returnRequest->channel_error_checkbox }}" @if ($returnRequest->channel_error_checkbox == 1) checked @endif>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="port-error" name="port_error_checkbox" type="checkbox" value="{{ $returnRequest->port_error_checkbox }}" @if ($returnRequest->port_error_checkbox == 1) checked @endif>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="laser-tx-faulty" name="laser_tx_faulty_checkbox" type="checkbox" value="{{ $returnRequest->laser_tx_faulty_checkbox }}" @if ($returnRequest->laser_tx_faulty_checkbox == 1) checked @endif>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="laser-rx-faulty" name="laser_rx_faulty_checkbox" type="checkbox" value="{{ $returnRequest->laser_rx_faulty_checkbox }}" @if ($returnRequest->laser_rx_faulty_checkbox == 1) checked @endif>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="physical-damage" name="physical_damage_checkbox" type="checkbox" value="{{ $returnRequest->physical_damage_checkbox }}" @if ($returnRequest->physical_damage_checkbox == 1) checked @endif>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="row mb-3">
                                            <div class="col-12 mb-3">
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" id="intermitent" name="intermitent_checkbox" type="checkbox" value="{{ $returnRequest->intermitent_checkbox }}" @if ($returnRequest->intermitent_checkbox == 1) checked @endif>
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" id="rectifier-fault" name="rectifier_fault_checkbox" type="checkbox" value="{{ $returnRequest->rectifier_fault_checkbox }}" @if ($returnRequest->rectifier_fault_checkbox == 1) checked @endif>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" id="charging-switch" name="charging_switch_checkbox" type="checkbox" value="{{ $returnRequest->charging_switch_checkbox }}" @if ($returnRequest->charging_switch_checkbox == 1) checked @endif>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" id="battery-fault" name="battery_faulty_checkbox" type="checkbox" value="{{ $returnRequest->battery_faulty_checkbox }}" @if ($returnRequest->battery_faulty_checkbox == 1) checked @endif>
                                                </div>
                                            </div>

                                            <div class="col-12 mb-3">
                                                <label for="number-of-tribu"><b>Number of Tribu</b></label>
                                                <input class="form-control" id="number-of-tribu" type="number" name="number_of_tribu" value="{{ $returnRequest->number_of_tribu }}">
                                            </div>

                                            <div class="col-12 mb-3">
                                                <label for="number-of-char"><b>Number of Char</b></label>
                                                <input class="form-control" id="number-of-char" type="number" name="number_of_char" value="{{ $returnRequest->number_of_char }}">
                                            </div>

                                            <div class="col-12 mb-3">
                                                <label for="number-of-port"><b>Number of Port</b></label>
                                                <input class="form-control" id="number-of-port" type="number" name="number_of_port" value="{{ $returnRequest->number_of_port }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" id="misscellaneous-input" name="misscellaneous" rows="3">{{ $returnRequest->misscellaneous }}</textarea>
