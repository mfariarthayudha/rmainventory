                                ...
                                <form method="post" action="/users/_add-user">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12 col-lg-6">
                                            <div class="col-12 mb-3">
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" id="continue" type="checkbox">
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" id="dead-on-arrival" type="checkbox">
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" id="dead-on-operational" type="checkbox">
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" id="ber-indicator" type="checkbox">
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" id="software-error" type="checkbox">
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" id="tributary-error" type="checkbox">
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" id="channel-error" type="checkbox">
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" id="port-error" type="checkbox">
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" id="laser-tx-faulty" type="checkbox">
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" id="physical-damage" type="checkbox">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <div class="row mb-3">
                                                <div class="col-12 mb-3">
                                                    <label for="continue"><b>Intermitent</b></label>

                                                    <div class="form-check mb-3">
                                                        <input class="form-check-input" id="flexCheckDefault" type="checkbox">
                                                        <label class="form-check-label" for="flexCheckDefault">Indikasi error terjadi kadang-kadang / random</label>
                                                    </div>
                                                </div>

                                                <div class="col-12 mb-3">
                                                    <label for="valuation-type-input"><b>Rectifier/Inverter fault (Input/Output Voltage/Current Fault)</b></label>
                                                    <select class="form-control" id="valuation-type-input" name="valuationType" value="{{ old('valuationType') }}">
                                                        <option>ex-Project</option>
                                                        <option>Dismantle</option>
                                                        <option>Rusak-L</option>
                                                ...
                                                <div class="col-12 mb-3">
                                                    <label for="valuation-type-input"><b>Charging/Static Switch</b></label>
                                                    <select class="form-control" id="valuation-type-input" name="valuationType" value="{{ old('valuationType') }}">
                                                        <option>ex-Project</option>
                                                        <option>Dismantle</option>
                                                        <option>Rusak-L</option>
                                                ...
                                                <div class="col-12 mb-3">
                                                    <label for="valuation-type-input"><b>Battery Faulty</b></label>
                                                    <select class="form-control" id="valuation-type-input" name="valuationType" value="{{ old('valuationType') }}">
                                                        <option>ex-Project</option>
                                                        <option>Dismantle</option>
                                                        <option>Rusak-L</option>
                                                ...
                                                <div class="col-12 mb-3">
                                                    <label for="serial-number-input"><b>Number of Tribu</b></label>
                                                    <input class="form-control" id="serial-number-input" type="text" name="serialNumber" value="{{ old('serialNumber') }}" placeholder="Masukkan Serial Number">
                                                    <small class="text-danger">{{ $errors->first('serialNumber') }}</small>
                                                </div>

                                                <div class="col-12 mb-3">
                                                    <label for="serial-number-input"><b>Number of Char</b></label>
                                                    <input class="form-control" id="serial-number-input" type="text" name="serialNumber" value="{{ old('serialNumber') }}" placeholder="Masukkan Serial Number">
                                                    <small class="text-danger">{{ $errors->first('serialNumber') }}</small>
                                                </div>

                                                <div class="col-12 mb-3">
                                                    <label for="serial-number-input"><b>Number of Port</b></label>
                                                    <input class="form-control" id="serial-number-input" type="text" name="serialNumber" value="{{ old('serialNumber') }}" placeholder="Masukkan Serial Number">
                                                    <small class="text-danger">{{ $errors->first('serialNumber') }}</small>
                                                </div>
                                            </div>
